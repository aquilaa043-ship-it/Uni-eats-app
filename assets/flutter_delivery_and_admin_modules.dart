...
class UniEatsControlHub extends StatefulWidget {
  const UniEatsControlHub({Key? key}) : super(key: key);
...
class _UniEatsControlHubState extends State<UniEatsControlHub> {
  int _currentModuleIndex = 0; // 0 = Checkout, 1 = Rastreio, 2 = Extrato Lojista, 3 = Painel Motoboy, 4 = Carteira Motoboy, 5 = Super Admin
